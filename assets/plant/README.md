...
Pointer entry (mouse), click, touch and native button keyboard activation nurture the plant. Two fruits fade next to the parent; one drops to the lower soil. The new sprout gently returns to the original growing area so repeated cycles cannot run off the page. Random breezes animate the leaves. Rendering pauses while the component or document is hidden. Reduced motion disables idle growth and wind; direct interaction remains available.
